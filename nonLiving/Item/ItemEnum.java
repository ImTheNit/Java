...
public enum ItemEnum {
	...
	EMPTY("empty item",ItemType.EMPTY,PassivEffect.NONE,ActivEffect.NONE,1,""),
	
	
	
	NORMAL_HELMET("normal helmet",ItemType.HELMET,PassivEffect.SMALL_INCREASE_LIFE,ActivEffect.NONE,1,"Helmet.png"),
